    ...
    public class AccountController : ApplicationBaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["Updated"] = "Người dùng mới đã được thêm";
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string _topicMail = string.Format("Ngày {0} Email khôi phục mật khẩu tài khoản {1}", DateTime.Now.ToString(), user.UserName);
                var _cA = LoadConfigAccount();
                Configs.Sendmail(_cA.Email, _cA.EmailPass, user.Email, _cA.MailHost, _cA.MailPort, _cA.MailEnableSsl.Value, _cA.MailTimeout, _topicMail, _bodyMail);
        ...
        public ConfigAccount LoadConfigAccount()
        {
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            //ModelState.AddModelError("", "Có lỗi xảy ra trong quá trình tạo mật khẩu.");
            AddErrors(result);
            return View();
        }
